...
public class SchemaConfigListMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(SCHEMACONFIGLIST, PropertyDescriptorSupport.createCollection(SCHEMACONFIGLIST,
                SchemaConfig.class, 0, PROPERTY_CONSTRAINTS[0], false, PropertyAssociationType.COMPOSITION));
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(SchemaConfigListMsg.getPropertyDescriptor(SCHEMACONFIGLIST),
    ...
    public int hashCode() {
        ...
        result = ((PRIME * result) + ((this.schemaConfigList == null) ? 0 : this.schemaConfigList.hashCode()));
        return result;
    }
    ...
    public NabuccoList<SchemaConfig> getSchemaConfigList() {
        if ((this.schemaConfigList == null)) {
            this.schemaConfigList = new NabuccoListImpl<SchemaConfig>(NabuccoCollectionState.INITIALIZED);
        }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(SchemaConfigListMsg.class).getProperty(propertyName);
    }

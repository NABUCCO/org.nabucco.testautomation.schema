...
public class CreateSchemaConfigCommand implements NabuccoCommand {
    ...
    private CreateSchemaConfigCommandHandler createSchemaConfigCommandHandler = NabuccoInjector.getInstance(
            CreateSchemaConfigCommand.class).inject(CreateSchemaConfigCommandHandler.class);

 ...
 */
public class SchemaMaintainanceMasterDetailBlockLayouter extends
		MasterDetailBlockLayouter<SchemaMaintainanceMultiplePageEditViewModel> {

	/**
	 * Default constructor.
	 */
	public SchemaMaintainanceMasterDetailBlockLayouter() {
		super(
				"org.nabucco.testautomation.schema.ui.rcp.multipage.maintainance.masterdetails.title",
				"org.nabucco.testautomation.schema.ui.rcp.multipage.maintainance.masterdetails.description");
	}
	...
	public I18NLabelProviderContributor getMasterDetailLabelProvider() {
		return SchemaMaintainanceMasterDetailLabelProvider.getInstance();
	}

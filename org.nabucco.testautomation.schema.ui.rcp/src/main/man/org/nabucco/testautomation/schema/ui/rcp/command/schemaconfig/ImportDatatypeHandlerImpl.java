 ...
 */
public class ImportDatatypeHandlerImpl extends NabuccoAbstractImportDatatypeCommandHandlerImpl<SchemaConfigEditBusinessModel, SchemaMaintainanceMultiplePageEditViewModel>
    ...
    @Override
    protected void importDatatype(SchemaMaintainanceMultiplePageEditViewModel viewModel,
    		SchemaConfigEditBusinessModel businessModel) throws ClientException {
        SchemaConfig response = businessModel.importDatatype(viewModel.getSchemaConfig());

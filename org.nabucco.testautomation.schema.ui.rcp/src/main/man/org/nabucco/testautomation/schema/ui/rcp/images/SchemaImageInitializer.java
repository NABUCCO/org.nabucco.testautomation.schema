 ...
 */
public class SchemaImageInitializer {

	private static SchemaImageInitializer instance;

	private SchemaImageInitializer() {
	}

	/**
	 * Singleton constructor.
	 * 
	 * @return The singleton instance of SchemaImageInitializer
	 */
	public static SchemaImageInitializer getInstance() {
		if (instance == null) {
			instance = new SchemaImageInitializer();
		}
		return instance;
	}
	 ...
	 * {@link SchemaImageRegistry}.
	 */
	public void initializeComponentImages() {
		for (SchemaImageRegistry imageConfig : SchemaImageRegistry.values()) {

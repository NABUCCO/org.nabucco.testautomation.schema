...
/**
 * MaintainSchema<p/>SchemaConfig maintenance service<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-04-09
 */
public interface MaintainSchema extends Service {
     ...
     */
    ServiceResponse<SchemaConfigMsg> maintainSchemaConfig(ServiceRequest<SchemaConfigMsg> rq) throws MaintainException;
}

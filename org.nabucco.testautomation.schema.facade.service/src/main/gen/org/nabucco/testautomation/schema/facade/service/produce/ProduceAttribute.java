...
/**
 * ProduceAttribute<p/>Attribute produce service<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2010-04-13
 */
public interface ProduceAttribute extends Service {
     ...
     */
    ServiceResponse<AttributeMsg> produceAttribute(ServiceRequest<EmptyServiceMessage> rq)
            throws ProduceException;
}

...
/**
 * ExportServiceHandler<p/>Export Service for Schema<p/>
 *
 * @version 1.0
...
public abstract class ExportServiceHandler extends ServiceHandlerSupport implements ServiceHandler {
    ...
    private static final String ID = "org.nabucco.testautomation.schema.impl.service.export.ExportServiceHandler";

...
/**
 * ImportSchemaServiceHandler<p/>Service to import Schema<p/>
 *
 * @version 1.0
 * @author Steffen Schmidt, PRODYNA AG, 2011-02-14
 */
public abstract class ImportSchemaServiceHandler extends ServiceHandlerSupport implements
        ServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.testautomation.schema.impl.service.importing.ImportSchemaServiceHandler";

    /** Constructs a new ImportSchemaServiceHandler instance. */
    public ImportSchemaServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<ImportRs> invoke(ServiceRequest<ImportRq> rq) throws ImportException {
        ...
        try {
            ...
            msg = this.importSchema(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws ImportException
     */
    protected abstract ImportRs importSchema(ImportRq msg) throws ImportException;
